...
echo This script is for: Forge 1.9-12.16.1.1934
PAUSE
test&cls
echo INSTRUCTIONS:
...
PAUSE
powershell -Command "Invoke-WebRequest http://files.minecraftforge.net/maven/net/minecraftforge/forge/1.9-12.16.1.1934/forge-1.9-12.16.1.1934-installer.jar -OutFile forgeinstaller.jar"
...
echo Thank you for using JasonIEC's easy server installer for Forge 1.9-12.16.1.1934!
PAUSE
