...
echo This script is for: Forge 1.7.10-10.13.4.1614
PAUSE
test&cls
echo INSTRUCTIONS:
...
PAUSE
powershell -Command "Invoke-WebRequest http://files.minecraftforge.net/maven/net/minecraftforge/forge/1.7.10-10.13.4.1614-1.7.10/forge-1.7.10-10.13.4.1614-1.7.10-installer.jar -OutFile forgeinstaller.jar"
...
echo Thank you for using JasonIEC's easy server installer for Forge 1.7.10-10.13.4.1614!
PAUSE
